...
const Layout = () => {
  ...
  const handleClickOutside = (event) => {
    if (searchOpen && !event.target.closest(".layoutcss")) {
      setSearchOpen(false);
    }
  };
    ...
    <div style={{ display: "flex" }}>
      ...
      >
        ...
        <div className="layoutcss">
          ...
          <div onClick={openSearchBar} className="icon-name">
            <svg
          ...
          <Link  to='/createpost'><button className="edit-btn">Create Post</button></Link>
          <Link  to='/profile'><button className="edit-btn">Profile</button></Link>
          <div className="icon-name">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
      ...
      <div
        ...
        style={{ marginLeft: "232px", flex: 1, padding: "20px" }}
      >
